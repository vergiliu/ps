...
class FolderComparator:
    ...
    def syncNow(self):
        for myFile in self.inLeftButNotInRight:
            pass #shutil.copy2(self.leftFolder + myFile, self.rightFolder + myFile)
        for myFile in self.inRightButNotInLeft:
            pass #shutil.copy2(self.rightFolder + myFile, self.leftFolder + myFile)

        for myFile in self.inBothButDifferent:
            pass #print("default keep both copies, use bigger file, use newer file")
